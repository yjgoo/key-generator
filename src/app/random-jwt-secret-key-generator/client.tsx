...
interface JWTSecretKeyGeneratorClientProps {
  generator: KeyGenerator;
}

export function JWTSecretKeyGeneratorClient({ generator }: JWTSecretKeyGeneratorClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <StructuredData generator={generator} pageUrl="https://key-generator.com/random-jwt-secret-key-generator" />
      <Header />
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 mb-12">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900">Generated JWT Secret Key</h3>
              <div className="relative">
                <textarea
                  ...
                  placeholder="Click generate to create a new JWT secret key..."
                />
                {generatedKey && (
                  <button
